...
class PPNet(nn.Module):
    ...
    def forward(self, x):
        ...
        local_proto_activations = local_activations if self.use_global else prototype_activations
        global_proto_activations = global_activations if self.use_global else None
        ...
        return logits, (
            ...
            cls_attn_rollout,
            original_fea_len,
            local_proto_activations,
            global_proto_activations,
        )
